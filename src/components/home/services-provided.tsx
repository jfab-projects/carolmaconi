          ...
          <li className="bg-none bg-transparent">
            ...
            <div className="bg-white shadow-lg p-4 max-w-[84%] m-auto text-center relative -top-12">
              ...
              <p className="opacity-60 mt-3">
                ...
                estudo de layout, até a escolha dos acabamentos e iluminação,
                para transformar seus espaços em locais acolhedores e
                funcionais. Resultado: Ambientes bonitos, práticos e com a sua
                cara.
              </p>
            </div>
          </li>
        ...
        <AnimatedContent delay={0.4}>
          <li className="bg-none bg-transparent">
            ...
            <div className="bg-white shadow-lg p-4 max-w-[84%] m-auto text-center relative -top-12">
              ...
              <p className="opacity-60 mt-3">
                Orientações pontuais para tirar dúvidas e tomar decisões com
                mais segurança. Ideal para quem precisa de um olhar profissional
                antes de reformar, decorar ou começar uma obra.
              </p>
            </div>
          </li>
        </AnimatedContent>
