    ...
    <Dialog>
      <DialogTrigger asChild>
        <div className="group cursor-pointer overflow-hidden">
          ...
          <h2 className="mt-6 max-md:text-3xl transition-transform duration-300 group-hover:translate-x-2">
            {name}
          </h2>
      ...
      <DialogContent className="min-w-[80%] max-md:max-w-[90%]">
        ...
        <DialogDescription className="sr-only">asd</DialogDescription>
